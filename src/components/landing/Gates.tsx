      ...
      <div className="grid gap-12 lg:grid-cols-[1fr_1.2fr] lg:gap-16 items-start">
        ...
        >
          ...
          {GATES.map((gate, i) => {
            const Icon = icons[i];
            return (
              <Reveal key={gate.id} delay={i * 110} className="w-[78%] shrink-0 snap-center sm:w-[46%] lg:w-auto lg:shrink">
                <li className="group relative flex h-full w-full min-w-0 flex-col gap-3 rounded-3xl border border-border bg-card p-4 shadow-sm transition-all duration-300 hover:-translate-y-0.5 hover:shadow-lg sm:flex-row sm:gap-5 sm:p-7">
          ...
          <Reveal delay={460} variant="scale" className="w-[78%] shrink-0 snap-center sm:w-[46%] lg:w-auto lg:shrink">
