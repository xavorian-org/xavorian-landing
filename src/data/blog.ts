...
export const BLOG_POSTS: BlogPost[] = [
  ...
  },
  {
    ...
    body: [
      ...
      'Where does Xavorian sit in these numbers? Our four gates exist because each number in this post maps to one: identity and liveness answer to the NIN-era identity rails; the name-matched verified bank account answers the move-money-fast problem; AI document audit plus human review answers the forgery epidemic FITC keeps measuring; and city-by-city pre-launch waiting answers the desperation that sends money before physics is checked. We are not smarter than the fraud problem. We simply decided the gates get enforced as infrastructure, not as advice.',
