...
export const BLOG_POSTS: BlogPost[] = [
  ...
  },
  {
    ...
    body: [
      ...
      'The clean defence is not vigilance, because vigilance gets tired by the third viewing of the week. The clean defence is verification. On Xavorian, before a listing can exist, the person behind it clears a government ID check with liveness, a bank-account name match, a document scan with AI truthing and an automated multi-layer verification audit. A clone has to clear all four gates to reach your screen. The pipeline exists to make sure it does not.',
  ...
  },
  {
    ...
    body: [
      ...
      "This is the standard 'verified' should have meant all along: a checklist, a record, and a system that answers for the yes. It is the standard every Xavorian listing is held to, everywhere in Nigeria.",
    ],
  },
  {
    ...
    body: [
      ...
      'This is exactly the logic Xavorian is built on. Listings clear identity checks, liveness checks, bank-name matching, document scanning and automated multi-layer verification before they go live, and payments route to name-matched verified accounts. Treat it as a verification-first filter, not a promise of perfection. The habits in this guide remain yours to keep.',
  ...
  },
  {
    ...
    body: [
      ...
      'What does Xavorian do instead? The viewing moves to the middle of the journey, after the risk has been screened: listings only exist after identity, liveness, bank-name match, document and automated-verification gates, and payments route to accounts whose names match verified identities. Small untraceable fees to anonymous strangers are exactly what this design refuses to host.',
  ...
  },
  {
    ...
    body: [
      ...
      "Where verified platforms help: on Xavorian, a listing exists only after identity and liveness checks, bank-name match, document audit with AI truthing, and automated multi-layer verification — so a cloned-photo listing trips over the file before it ever reaches the screen. At the money step, payments route to the name-matched verified account of whoever passed KYC, not someone else's account. A scammer can borrow your pictures. They cannot borrow your verified identity, and the market should stop letting them borrow your address.",
  ...
  {
    slug: 'nigerian-property-fraud-by-the-numbers',
    title: 'Fraud, by the numbers: what the FBI, NIBSS and the housing ministry tell us about Nigerian property',
    excerpt:
      '₦600 trillion in instant payments, ₦17.67 billion in bank fraud, 14.9 million unbuilt homes, and 114 million registered identities. What the verified numbers actually say about safety in Nigerian real estate.',
    date: '2026-08-17',
    ...
    body: [
      'When the question "is Nigerian property really that dangerous" comes up, it usually becomes a shouting match between someone with a scam story and someone selling something. Numbers end shouting matches. So here are the most authoritative figures we could find on fraud, payments, identity and housing in Nigeria, what they mean, and what we think the exit ramp looks like.',
      'First, the speed of the money. According to NIBSS, the Nigeria Inter-Bank Settlement System, instant payments in Nigeria hit ₦600.36 trillion in 2023, up 55 percent from ₦387 trillion in 2022. Nigerians now move money by phone with a confidence that was unthinkable a decade ago. That speed is the good news.',
      'Now the bill for that speed. The NIBSS 2023 Annual Fraud Landscape records that financial institutions lost ₦17.67 billion to fraud in 2023, across 95,620 recorded fraud incidents. Banks carried about 92 percent of those incidents. Every fraudster who targets a property payment is counting on one thing: once the transfer clears, it moves faster than the police.',
      'And it is getting worse, quickly. The Financial Institutions Training Centre, FITC, reported that Nigerian banks lost ₦42.6 billion to fraud and forgeries in the second quarter of 2024 alone, three months, April to June — a single quarter exceeding the total recorded for the whole of 2023. Fraud is not shrinking; it is industrialising.',
      'What does bank fraud have to do with property? Everything. Property fraud in Nigeria is a species of advance-fee fraud: the inspection fee, the commitment fee, the "pay to hold it" deposit. Advance-fee fraud has been on the statute books since Section 419 of our Criminal Code, and the EFCC Act of 2004 puts advance-fee and property fraud inside the Commission\'s core mandate. The scam we all know at the viewing gate is not new verse. It is the oldest verse, sung over mobile money now.',
      'Nor is this uniquely Nigerian. In the United States, the FBI\'s Internet Crime Complaint Center, IC3, warned in its June 2023 public advisory that business email compromise tied to real estate accounted for nearly $446 million in reported victim losses, with real-estate BEC reports up about 27 percent between 2020 and 2022. The same IC3 logged 880,418 complaints for 2023 as a whole, with potential losses above $12.5 billion. Fraud follows money into every market. The markets that survive it are the ones that build hygiene into the rails.',
      'Third figure: the identity rails. By the end of 2024, NIMC, the National Identity Management Commission, had 114 million National Identification Numbers on register, with Lagos State leading at over 13 million enrolments. Ten years ago there was no realistic way to check that the stranger holding your deposit was the person they claimed. Today a verified identity layer exists at national scale. Verification at market entry is no longer a fantasy.',
      'Fourth figure: the pressure pushing people into rushed payments. For years everyone quoted a housing deficit of twenty, twenty-two, even twenty-eight million units. In January 2026 the National Housing Data Technical Committee, inaugurated by the Federal Ministry of Housing and Urban Development, released its first data-driven figure: Nigeria\'s housing deficit for 2025 stands at approximately 14.9 million units (14.925 million). Refined methodology or not, the reality is the same — millions compete for too few homes, and urgency is a scammer\'s oldest friend. Desperation signs contracts without reading them.',
      'Line these figures up and a shape appears. Payments are instant and enormous (₦600 trillion). Fraud scaled alongside (₦17.67 billion, then ₦42.6 billion). The identity infrastructure to check who is who now exists (114 million NINs). The scarcity that makes buyers hurry is real and officially measured (14.9 million). The only piece of this puzzle that society has not yet standardised is the one in the middle: verification.',
      'What does that mean in plain behaviour? Never wire money to an account name that does not match verified identity. Never accept documents you cannot check at a registry you chose. Never let urgency skip a step that takes two days. These rules are boring because fraud itself is boring. It hates checklist behaviour the way germs dislike soap.',
      'Where does Xavorian sit in these numbers? Our four gates exist because each number in this post maps to one: identity and liveness answer to the NIN-era identity rails; the name-matched verified bank account answers the move-money-fast problem; the AI document audit answers the forgery epidemic FITC keeps measuring; and city-by-city pre-launch waiting answers the desperation that sends money before physics is checked. We are not smarter than the fraud problem. We simply decided the gates get enforced as infrastructure, not as advice.',
      'One honest note, because this post is about information you should be able to trust: verification is a filter, not a force field. Even the IC3 figures only count what victims reported. Nobody on earth promises you a scam-proof market, and anyone who does is selling something. The sane goal is to shrink the pool you are forced to trust, and to make every naira land in an account whose name has been faced, matched and recorded.',
      'Sources for the figures above: NIBSS instant-payment statistics for 2023 (as reported by TheCable and Nairametrics, February 2024); NIBSS 2023 Annual Fraud Landscape; FITC Fraud and Forgeries Q2 2024 report (as covered by Punch and Nairametrics, September 2024); FBI IC3 June 2023 public service announcement on real-estate BEC and the IC3 2023 Internet Crime Report; NIMC NIN enrolment data (as reported December 2024); Federal Ministry of Housing and Urban Development, National Housing Data Technical Committee release (January 2026). If a figure reads off, tell us — this post will be corrected and the correction noted.',
    ],
  },
];
